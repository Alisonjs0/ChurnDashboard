...
const MainDashboard: React.FC<MainDashboardProps> = ({ clients }) => {
  ...
  const recentActivities = [
    {
      id: 1,
      client: 'MCI PLUS - auto x veículos',
      action: 'Status atualizado para CRÍTICO',
      time: '23/02/2026 14:30',
      type: 'alert',
    },
    {
      id: 2,
      client: 'TechFlow Solutions',
      action: 'Ação atribuída a Ana Silva',
      time: '26/02/2026 10:15',
      type: 'assignment',
    },
    {
      id: 3,
      ...
      time: '25/02/2026 16:45',
      type: 'meeting',
    },
    {
      id: 4,
      client: 'CloudVision Corp',
      action: 'Análise iniciada',
      time: '24/02/2026 09:20',
      type: 'analysis',
    },
  ];
